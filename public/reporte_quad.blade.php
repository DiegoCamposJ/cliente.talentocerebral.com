        ...
        <div class="container">
            ...
            @if($campana->demo == 'NO')                        
                ...
                <div class="saltoDePagina"></div>
                    ...
                    <div class="saltoDePagina"></div>
                    <br><br>
                    @include('quad.paginas.7')
                    <div class="saltoDePagina"></div>
                    <br><br>
                    <!--PÁGINA 8-->
                    @include('quad.paginas.8')
                    <div class="saltoDePagina"></div>
                    <br><br>
                    @include('quad.paginas.9')
                    <!-- PAGINA 10 - CÓDIGO DE PERFIL-->
                    <br><br><br><br><br>
                    @include('quad.paginas.10')
                    <!-- PAGINA 11 - CÓDIGO CEREBRAL-->
                    <div class="saltoDePagina"></div>
                    <br><br>
                    @include('quad.paginas.11')                        
                    
                    @if($evaluacion->campana_id != '15')
                        <br>
                        @include('quad.paginas.12')
                    @endif
                    <div class="saltoDePagina"></div>
    ...
    //var colors = [color.primary._500, color.fusion._500, color.danger._500, color.warning._500];
            ...
            function leyandaCircustancial()
            {
                var ctx = document.getElementById('leyendacomportamientoc').getContext('2d');
                    ...
                    ctx.font = "bold 12px sans-serif";
                    ctx.fillText("Circunstancial",260,20);
            }
