                ...
                <div class="panel-container show">
                    <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nombre" id="nombre" class="form-control form-control-lg rounded-0 border-top-0 border-left-0 border-right-0 px-0" value="{{$empresa->nombre}}">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="simpleinput">Ciudad</label>
                                <input type="text" name="ciudad" id="ciudad" class="form-control form-control-lg rounded-0 border-top-0 border-left-0 border-right-0 px-0" value="{{$empresa->ciudad}}">
                            </div>
                            <div class="form-group">
