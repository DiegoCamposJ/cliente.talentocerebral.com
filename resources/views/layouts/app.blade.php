...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Cerebro360 - @yield('title')</title>
                ...
                <aside class="page-sidebar">
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <ul id="js-nav-menu" class="nav-menu">
                            <li>
                                    <a href="{{ URL::to('evaluacion') }}" data-filter-tags="font icons">
                                        <i class="fad fa-trophy-alt"></i>
                                        <span class="nav-link-text" data-i18n="nav.font_icons">Evaluaciones</span>
                                    </a>
                            </li>
                        </ul>
                        <!-- MENU PRINCIAL FIN -->
