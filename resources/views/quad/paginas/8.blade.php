...
<div class="row row-divided">
    ...
    <div class="col-sm-6 text-justify">
        ...
        <br>
        <div id="pag8text1" class="text-justify fs-xl keep-print-font pt-1 l-h-n m-0">
        ...
        <br><br>
        <div id="pag8text2" class="text-justify fs-xl keep-print-font pt-1 l-h-n m-0">
            @if(abs($MO_VALOR1) > 4 )
                @switch($MOV_CUAD1)
                    @case('AZUL')
        ...
        <div id="pag8text3" class="text-justify fs-xl keep-print-font pt-1 l-h-n m-0">
            @if(abs($MO_VALOR2) > 4 )
                @switch($MOV_CUAD2)
                    @case('AZUL')
