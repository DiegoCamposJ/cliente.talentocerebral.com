        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="text-center">
                    <br>
                    @if($evaluacion->sexo == 'F')
                        <img src="{{ asset('img/brain/girl.png') }}" style=" display: block;margin-left: auto;margin-right: auto;width: 40%; height: 50%;">

                    @else
                        <img src="{{ asset('img/brain/boy.png') }}" style=" display: block;margin-left: auto;margin-right: auto;width: 40%; height: 50%;">
                    @endif
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div id="barDescriptoresHemisferios">
                        <canvas style="width:100%; height:320px;"></canvas>
                    </div>
                </div>
