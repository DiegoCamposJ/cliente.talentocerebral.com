...
<div class="row row-divided">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div id="inteligencias">
                    <canvas style="width:50px; height:50px;"></canvas>
                </div>
                <br><br>
    ...
    <div class="col-sm-6 text-center">
        ...
        <div class="row">
            <div class="col-sm-2">
                <img src="{{ asset('img/quad/1.png') }}" style="width: 10mm; height: 10mm; opacity: 1;">
            </div>

            <div class="col-sm-10 text-justify fs-xl keep-print-font pt-1 l-h-n m-0">
                <strong>RESOLUTOR: </strong>Visualiza problemas con claridad y sugiere soluciones eficientes
            </div>
        </div> <br>
        <div class="row">
            <div class="col-sm-2">
                <img src="{{ asset('img/quad/2.png') }}" style="width: 10mm; height: 10mm; opacity: 1;">
            </div>
            <div class="col-sm-10 text-justify fs-xl keep-print-font pt-1 l-h-n m-0">
        ...
        <div class="row">
            <div class="col-sm-2">
                <img src="{{ asset('img/quad/3.png') }}" style="width: 10mm; height: 10mm; opacity: 1;">
            </div>
            <div class="col-sm-10 text-justify fs-xl keep-print-font pt-1 l-h-n m-0">
        ...
        <div class="row">
            <div class="col-sm-2">
                <img src="{{ asset('img/quad/4.png') }}" style="width: 10mm; height: 10mm; opacity: 1;">
            </div>
            <div class="col-sm-10 text-justify fs-xl keep-print-font pt-1 l-h-n m-0">
        ...
        <div class="row">
            <div class="col-sm-2">
                <img src="{{ asset('img/quad/5.png') }}" style="width: 10mm; height: 10mm; opacity: 1;">
            </div>
            <div class="col-sm-10 text-justify fs-xl keep-print-font pt-1 l-h-n m-0">
        ...
        <div class="row">
            <div class="col-sm-2">
                <img src="{{ asset('img/quad/6.png') }}" style="width: 10mm; height: 10mm; opacity: 1;">
            </div>
            <div class="col-sm-10 text-justify fs-xl keep-print-font pt-1 l-h-n m-0">
        ...
        <div class="row">
            <div class="col-sm-2">
                <img src="{{ asset('img/quad/7.png') }}" style="width: 10mm; height: 10mm; opacity: 1;">
            </div>
            <div class="col-sm-10 text-justify fs-xl keep-print-font pt-1 l-h-n m-0">
        ...
        <div class="row">
            <div class="col-sm-2">
                <img src="{{ asset('img/quad/8.png') }}" style="width: 10mm; height: 10mm; opacity: 1;">
            </div>
            <div class="col-sm-10 text-justify fs-xl keep-print-font pt-1 l-h-n m-0">
