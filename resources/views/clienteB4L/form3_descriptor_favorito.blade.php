                            ...
                            <tr>
                                <td class="text-justify fs-xl" style="width: 50%"> <strong>{{$pregunta->descripcion}}</strong></td>
                                    ...
                                    <td class="text-center">
                                        {{ link_to_action('EvaluacionController@guardarDescriptorFavorito', $title = 'OK', $parameters = [3,$pregunta->slug], $attributes = ['class' => 'btn btn-success btn-lg btn-icon rounded-circle waves-effect waves-themed']) }}
                                    </td>
                            </tr>
                            @endforeach
                        </tbody>
