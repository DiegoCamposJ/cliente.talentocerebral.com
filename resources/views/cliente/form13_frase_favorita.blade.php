    ...
    <div class="col-sm-6">
        <div id="panel-2" class="panel">
            <div class="panel-hdr">
                <div class="col-sm-6">
                    <h2>
                        FRASES FAVORITAS &nbsp;{{ $selecionados }}/4
                    </h2>
                </div>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <span class="text-justify">
                        Entre la siguiente lista de frases, seleccione las 4 que mejor describa su personalidad.
                    </span>
                    <br><br>
                            ...
                            <tr>
                                <td class="text-justify fs-xl" style="width: 80%"> <strong>{{$pregunta->descripcion}}</strong></td>
                                    ...
                                    <td class="text-center">
                                        {{ link_to_action('EvaluacionController@guardarFrasesFavoritas', $title = 'OK', $parameters = [4,$pregunta->slug], $attributes = ['class' => 'btn btn-primary btn-lg btn-icon rounded-circle waves-effect waves-themed']) }}
                                    </td>
                            </tr>
                            @endforeach
                        </tbody>
