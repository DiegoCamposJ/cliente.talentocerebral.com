    ...
    <div class="col-sm-6">
        <div id="panel-2" class="panel">
            <div class="panel-hdr">
                <div class="col-sm-6">
                    <h2>
                        AFICIONES Y HOBBIES &nbsp;{{ $selecionados }}/6
                    </h2>
                </div>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <span class="text-justify">
                        Del total de Aficiones o Hobibies que se listan a continuación por favor seleccione los 6 que mas le guste practicar o le interesen.
                    </span>
                    <br><br>
                    ...
                    <table class="table table-sm m-0">
                        <thead class="bg-primary-900">
                            <th class="text-center">Aficiones</th>
                            ...
                            <tr>
                                <td class="text-justify fs-xl" style="width: 50%"> <strong>{{$pregunta->descripcion}}</strong></td>
                                    ...
                                    <td class="text-center">
                                        {{ link_to_action('EvaluacionController@guardarAficiones', $title = 'OK', $parameters = [5,$pregunta->slug], $attributes = ['class' => 'btn btn-primary btn-lg btn-icon rounded-circle waves-effect waves-themed']) }}
                                    </td>
                            </tr>
                            @endforeach
                        </tbody>
