                            ...
                            <tr>
                                <td class="text-justify fs-xl" style="width: 50%"> <strong>{{$carrera->carrera}}</strong></td>
                                    ...
                                    <td class="text-center">
                                        {{ link_to_action('EvaluacionController@guardarCarrera', $title = 'Seleccionar', $parameters = [$slugEvaluacion,$carrera->id], $attributes = ['class' => 'btn btn-primary btn-lg btn-icon rounded-circle waves-effect waves-themed']) }}
                                    </td>
                            </tr>
                            @endforeach
                        </tbody>
